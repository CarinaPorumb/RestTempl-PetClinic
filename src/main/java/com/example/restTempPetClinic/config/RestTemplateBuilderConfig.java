package com.example.restTempPetClinic.config;
...
public class RestTemplateBuilderConfig {
    ...
    @Bean
    RestTemplateBuilder restTemplateBuilder(RestTemplateBuilderConfigurer config, OAuthClientInterceptor interceptor) {
        assert rootUrl != null;
